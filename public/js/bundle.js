...
var displayMap = function displayMap(locations) {
  var map = new mapboxgl.Map({
    ...
    accessToken: 'pk.eyJ1IjoiYXJ0dXJhdmd1c3QiLCJhIjoiY2xrY2JtNmsyMDJ2ZTNkcXlocDR5bnJydCJ9.FggFk18K5E_nmXPtLBOScg',
    scrollZoom: false
  });
...
exports.updateSettings = exports.resetPassword = void 0;
var _alerts = require("./alerts");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          url = "".concat(window.location.origin, "/api/v1/users").concat(window.location.pathname);
          if (!(data.password !== data.passwordConfirm)) {
            _context2.next = 4;
            break;
          }
          (0, _alerts.showAlert)('error', 'password not the same');
...
var resetPasswordForm = document.querySelector('.form--resetPasswordForm');
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            password = document.getElementById('password').value;
            passwordConfirm = document.getElementById('password__confirm').value;
            (0, _updateSettings.resetPassword)({
              password: password,
              passwordConfirm: passwordConfirm
            });
          case 4:
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "43431" + '/');
